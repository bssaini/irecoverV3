...
namespace SunCorp.Irecover.Android.UI.Activities
{
    [Activity(Label = "@string/app_name", Theme = "@style/AppThemeNoActionBar", ScreenOrientation = ScreenOrientation.Portrait,
        LaunchMode = LaunchMode.SingleTop, Name = "suncorp.irecover.android.ui.activities.NewClaimActivity")]
    public class NewClaimActivity : MvxAppCompatActivity
    {

        public new NewClaimViewModel ViewModel
        {
            get { return (NewClaimViewModel)base.ViewModel; }
