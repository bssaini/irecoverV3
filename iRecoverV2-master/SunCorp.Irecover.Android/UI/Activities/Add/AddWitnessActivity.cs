...
namespace SunCorp.Irecover.Android.UI.Activities.Add
{
    [Activity(Label = "@string/app_name", Theme = "@style/AppThemeNoActionBar", ScreenOrientation = ScreenOrientation.Portrait,
        LaunchMode = LaunchMode.SingleTop, Name = "suncorp.irecover.android.ui.activities.AddWitnessActivity")]
    public class AddWitnessActivity : MvxAppCompatActivity
    {

        public new AddWitnessViewModel ViewModel
        {
            get { return (AddWitnessViewModel)base.ViewModel; }
